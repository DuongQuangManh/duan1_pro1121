...
public class TopLoaiTheTapAdapter extends RecyclerView.Adapter<TopLoaiTheTapAdapter.ViewHolder> {
    private Context context;
    private List<ThongKe> list;

    public TopLoaiTheTapAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (thongKe!=null){
            ...
            holder.tv_name.setText(DuAn1DataBase.getInstance(context).loaiTheTapDAO().getName(thongKe.getCuahang_id()));

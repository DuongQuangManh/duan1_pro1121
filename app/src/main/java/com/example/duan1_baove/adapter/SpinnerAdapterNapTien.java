...
public class SpinnerAdapterNapTien extends ArrayAdapter<KhachHang> {
    private Context context;
    private int resource;
    private List<KhachHang> list;
    private LayoutInflater inflater;

    public SpinnerAdapterNapTien(@NonNull Context context, int resource, @NonNull List<KhachHang> objects) {
